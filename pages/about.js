...
function About() {
  return (
    <>
      <div className="relative flex justify-center items-center w-full min-h-screen font-Tenorsans font-bold !overflow-clip">
        ...
        <section className="absolute flex flex-col justify-end items-end top-0 left-0 w-[20%] h-[50%] lg:w-[40%] lg:h-[60%] bg-[#B09B71]">
          <span className="text-[#EDDFB3] text-[1em] lg:text-[8em]">About</span>
        </section>
        <section className="absolute flex flex-col justify-center items-center bottom-0 right-0 lg:right-[5em] w-[80%] h-[70%] lg:w-[50%] lg:h-[70%] bg-[#B09B71]">
